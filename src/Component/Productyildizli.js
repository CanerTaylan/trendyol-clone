...
function Productyildizli(props) {
                ...
                <div className="row">
                    <div className='product-slider'>
                        <div className='product-header'>
                            <div className='product-slider-name'>Yıldızlı Ürünler</div>
                        ...
                        <Slider {...settings}>
                            ...
                            <div>
                                <ProductContents
                                    stamp="./img/p/yildizli.webp"
                                    productimg="img/p/product-4.webp" pname="deneme ürün ismi 4" orgPrice="250TL"
                                    pprice="350TL" >
                                </ProductContents>
                            </div>
                            <div>
                            ...
                            <div>
                                <ProductContents
                                    stamp="./img/p/yildizli.webp" kargo="./img/p/kargo.png"
...
export default Productyildizli